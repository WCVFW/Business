  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-20 text-center">
        <div className="w-20 h-20 bg-gradient-to-br from-green-500 to-green-700 rounded-2xl flex items-center justify-center mx-auto mb-8 animate-float">
          <Bike className="w-10 h-10 text-white" />
        </div>
        <h1 className="text-5xl font-bold text-gray-900 mb-6">
          Bike <span className="text-green-600">Adventures</span>
        </h1>
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 mb-8">
          ...
          <p className="text-gray-600 mb-6">
            We're working on bringing you amazing bike tour experiences. Check
            back soon for guided tours, equipment rentals, and scenic routes.
          </p>
        </div>
        <Link
          to="/services"
